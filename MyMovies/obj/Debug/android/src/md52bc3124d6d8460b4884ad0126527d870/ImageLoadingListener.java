...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("UniversalImageLoader.Core.Listener.ImageLoadingListener, UniversalImageLoader, Version=1.9.4.0, Culture=neutral, PublicKeyToken=null", ImageLoadingListener.class, __md_methods);
	}


	public ImageLoadingListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == ImageLoadingListener.class)
			mono.android.TypeManager.Activate ("UniversalImageLoader.Core.Listener.ImageLoadingListener, UniversalImageLoader, Version=1.9.4.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
