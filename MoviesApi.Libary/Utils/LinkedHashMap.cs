...
namespace MoviesApi.Libary.Utils
{
    public class LinkedHashMap<T, U>
    {
        public Dictionary<T, LinkedListNode<Tuple<U, T>>> D = new Dictionary<T, LinkedListNode<Tuple<U, T>>>();
        public LinkedList<Tuple<U, T>> LL = new LinkedList<Tuple<U, T>>();
